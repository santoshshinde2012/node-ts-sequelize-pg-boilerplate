...
describe('Enquiry Controller', () => {
    ...
    it('should get all enquiries', async () => {
        ...
        await controller.getEnquiries(request as Request, response as Response, next);
    ...
    it('should get details of a specific enquiry', async () => {
        ...
        await controller.getEnquiry(request as Request, response as Response, next);
    ...
    it('should create enquiry', async () => {
        ...
        await controller.createEnquiry(request as Request, response as Response, next);
    ...
    it('should update enquiry', async () => {
        ...
        await controller.updateEnquiry(request as Request, response as Response, next);
